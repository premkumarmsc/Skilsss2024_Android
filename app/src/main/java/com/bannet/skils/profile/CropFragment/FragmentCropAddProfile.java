...
public class FragmentCropAddProfile extends PictureSelectorFragment {
    ...
    TextView a_p_s_tv2,a_p_s_tv3,a_p_s_tv4,a_p_s_tv5,a_p_s_tv6,title;
    ...
    public String code;
    public String select_address,select_country;

    public static FragmentCropAddProfile newInstance() {
        return new FragmentCropAddProfile();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       view = inflater.inflate(R.layout.fragment_crop_add_profile, container, false);
    ...
    private void init(View view){
        ...
        a_p_s_tv2 = view.findViewById(R.id.a_p_s_tv2);
        a_p_s_tv3 = view.findViewById(R.id.a_p_s_tv3);
        a_p_s_tv4 = view.findViewById(R.id.a_p_s_tv4);
        a_p_s_tv5 = view.findViewById(R.id.a_p_s_tv5);
        a_p_s_tv6 = view.findViewById(R.id.a_p_s_tv6);
        ...
        tfirstName = view.findViewById(R.id.enter_your_first_name);
        tlastName = view.findViewById(R.id.enter_your_last_name);
        tcompanyName = view.findViewById(R.id.enter_your_company_name);
        temailId = view.findViewById(R.id.enter_your_email_id);
        tpassword = view.findViewById(R.id.enter_your_password);
        tdescription = view.findViewById(R.id.enter_your_description);
        enterYourAddress = view.findViewById(R.id.enter_your_address);
        tReferCode = view.findViewById(R.id.edi_code);
        ...
        nextbtn = view.findViewById(R.id.update_btn);
        relative_add_certification =  view.findViewById(R.id.relative_add_certification);
        ...
        nextbtn.setOnClickListener(view4 -> {
        ...
        relative_add_certification.setOnClickListener(view7 -> {
            //startActivity(new Intent(context, ActivityAddCertificatins.class));
            addCertificate();
        });
        addDistrict.setOnClickListener(view12 -> {
        ...
        addCountry.setOnClickListener(view3 -> {

            enterYourAddress.setText("");
            addCountry();
        });

        addState.setOnClickListener(view8 -> {
            enterYourAddress.setText("");
    ...
    public void emailOrCountryValidate(){
    ...
    public boolean validation(){
        ...
        select_address = enterYourAddress.getText().toString().trim();
        select_country = a_p_s_tv2.getText().toString().trim();
        ...
        else if(file_name_profile.equals("")){
            Toast.makeText(context, GlobalMethods.getString(context,R.string.addProfileimage), Toast.LENGTH_SHORT).show();
            return  false;
        } else if (select_country.equals("") || select_address.equals("")) {

            GlobalMethods.Toast(context,"Please select Your Country or Address");
    ...
    private void uploadFile(String imagePath) {
        ...
        Log.e("fileToUpload", String.valueOf(fileToUpload));
