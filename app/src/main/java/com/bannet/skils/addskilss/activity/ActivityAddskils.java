package com.bannet.skils.addskilss.activity;
...
import com.bannet.skils.addskilss.cropview.FragmentCropAddskilsss;
...
public class ActivityAddskils extends AppCompatActivity {
    ...
    public String type;
    public LinearLayout linear_take_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addskils);
        getSupportActionBar().hide();
        context=ActivityAddskils.this;
...
//        nestedSV = findViewById(R.id.idNestedSV);
        ...
        image_name = in.getStringExtra("image_name");
        company_name = in.getStringExtra("company_name");
        country_id = in.getStringExtra("country");
        state_id = in.getStringExtra("state");
        city_id = in.getStringExtra("city");
        country_name = in.getStringExtra("country_name");
        state_name = in.getStringExtra("state_name");
        city_name = in.getStringExtra("city_name");
        about = in.getStringExtra("about");
        email = in.getStringExtra("email");
        password = in.getStringExtra("password");
        device_type = in.getStringExtra("device_type");
        device_token = in.getStringExtra("device_token");
        device_model = in.getStringExtra("device_model");
        device_version = in.getStringExtra("device_version");
        gender = in.getStringExtra("gender");
        certificate = in.getStringExtra("certificate_id");
        longitude = in.getStringExtra("longitude");
        lattitude = in.getStringExtra("lattitude");
        referCode = in.getStringExtra("refercode");
        liveAddress = in.getStringExtra("address");
        ...
        if(type.equals("profile_complected")){
            ...
            a_s_s_tv1.setText(GlobalMethods.getString(context,R.string.addSkills));

        }
        else {

            a_s_s_tv1.setText(GlobalMethods.getString(context,R.string.edit_skills));
...
//        });
//
//        sumitebtn.setOnClickListener(view -> {
//
//            if(type.equals("profile_complected")){
//
//                calRegister();
...
//        timepickerFromDialogbox.setOnClickListener(view -> timepickerFromDialog());
//
//        timepickertoDialogbox.setOnClickListener(view -> timepickerToDialog());
//
...
//        changeLanguage();
    ...
    public void initMainFragment() {
        ...
        in.putString("type",type);
                in.putString("first_name",first_name);
                in.putString("last_name",last_name);
                in.putString("image_name",image_name);
                in.putString("company_name",company_name);
                in.putString("country",country_id);
                in.putString("state",state_id);
                in.putString("city",city_id);
                in.putString("country_name",country_name);
                in.putString("state_name",state_name);
                in.putString("city_name",city_name);
                in.putString("about",about);
                in.putString("email",email);
                in.putString("password",password);
                in.putString("device_type",device_type);
                in.putString("device_token",device_token);
                in.putString("device_model",device_model);
                in.putString("device_version",device_version);
                in.putString("gender","1");
                in.putString("certificate_id",certificate);
                in.putString("longitude",longitude);
                in.putString("lattitude",lattitude);
                in.putString("refercode",referCode);
                in.putString("address",liveAddress);
                in.putString("code",code);
                in.putString("user_id",USER_ID);
        FragmentCropAddskilsss mFragment = FragmentCropAddskilsss.newInstance();
    ...
    private void chooseCategory() {
        timepickerdialog= new Dialog(ActivityAddskils.this);
        ...
        if(GlobalMethods.isNetworkAvailable(context)){
            progressDialog = ProgressDialog.show(ActivityAddskils.this, "", "Loading...", true);
    ...
    private void Updateskils(String user_id) {
        ...
        banner_images = String.valueOf(temp);

        if(GlobalMethods.isNetworkAvailable(ActivityAddskils.this)){
            progressDialog = ProgressDialog.show(ActivityAddskils.this, "", "Loading...", true);
                    ...
                    if(response.isSuccessful()){
                        ...
                        if(response.body().getStatus().equals("1")){
                            ...
                            for (int i=0; i < arrSplit.length; i++){
                                ...
                                recycler_images.setLayoutManager(new LinearLayoutManager(ActivityAddskils.this, LinearLayoutManager.HORIZONTAL, false));
