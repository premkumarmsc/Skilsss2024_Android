...
import com.bannet.skils.databinding.ActivityProffDetailsBinding;
...
public class ActivityProffDetails extends AppCompatActivity implements OnMapReadyCallback {

    public Context context;
    private ProgressDialog progressDialog;
    private String pressional_id,simage_url,simageName,USER_ID;
    public String type,usernumber;
    public ActivityProffDetailsBinding binding;
    private Boolean fav=false;
    public String userName,bannerImage,postImageUrl;
    ...
    public String longitude,lattitude,proffLatitude,proffLogitude;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityProffDetailsBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        context = ActivityProffDetails.this;
    ...
    private void init(){
        ...
        proffLatitude= getIntent().getStringExtra("latitude");
        proffLogitude= getIntent().getStringExtra("logitude");
        type= getIntent().getStringExtra("type");
        hireType= getIntent().getStringExtra("typehire");

        Log.e("hireTypedetails.....",hireType);
        ...
        binding.ratingBtn.setOnClickListener(view -> ShowBottomRatingbar());
        ...
        if(longitude.isEmpty()){
            ...
            double blati = Double.parseDouble(proffLatitude);
            double blong = Double.parseDouble(proffLogitude);
            ...
            Log.e("eCalculate",eCalculate);

            binding.txtKm.setText(eCalculate + "Km");
        }
    ...
    public boolean callisPermissionGranted() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (context.checkSelfPermission(Manifest.permission.READ_CONTACTS) == PackageManager.PERMISSION_GRANTED
                ...
                ActivityCompat.requestPermissions(ActivityProffDetails.this, new String[]{Manifest.permission.READ_CONTACTS,
...
//                ActivityCompat.requestPermissions(getActivity(), new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
    ...
    private void professionalDetails(String user_id, String profe_id) {
        ...
        if(GlobalMethods.isNetworkAvailable(ActivityProffDetails.this)){
                    ...
                    if(response.isSuccessful()){
                        ...
                        if(response.body().getStatus().equals("1")){
                            ...
                            for (String imageName : arrSplit) {
                                ...
                                binding.viewPager.setSliderAdapter(adapterViewPager);
