...
public class IAPHelper {
     ...
     *  @param context           It will be used to get an application context to bind to the in-itrdonline billing service.
    ...
    /**
     * Get purchases details for all the items bought within your itrdonline.
     */
...
//    }
            ...
            public void onSkuDetailsResponse(BillingResult billingResult, List<SkuDetails> skuDetailsList) {
                if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK && skuDetailsList != null) {
                    for (SkuDetails skuDetails : skuDetailsList) {
                        ...
                        Log.e("skuDetails.getSku()",skuDetails.getSku());
                    }
                    if (IAPHelperListener != null)
    ...
    /**
     * Initiate the billing flow for an in-itrdonline purchase or subscription.
     *
     ...
     * something within the itrdonline or by initiating a purchase from Google Play Store.
     */
